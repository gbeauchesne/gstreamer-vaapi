...
static inline GstVaapiPictureH264 *
gst_vaapi_picture_h264_new_clone(GstVaapiDecoderH264 *decoder,
    GstVaapiPictureH264 *picture)
{
    ...
    GstH264SliceHdr *slice_hdr)
{
    ...
    for (;;) {
        ...
        /* Create new picture */
        if (prev_picture)
            lost_picture = gst_vaapi_picture_h264_new_clone(decoder,
                prev_picture);
        else
        ...
        lost_picture->output_flag       = FALSE;
